                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="invoice-title">
                                    <h4 class="float-end font-size-16"><strong>Invoice Number #{{ $payment->invoice->invoice_no }}</strong></h4>
                                    <h3>
                                    ...
                                    <div class="">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td colspan="4" style="text-align: center;font-weight:bold;">{{ date('d-m-Y', strtotime($details->date)) }}</td>
                                                    <td colspan="3" style="text-align: center;font-weight:bold;">${{ $details->current_paid_amount }}</td>
                                                </tr>
                                                @endforeach

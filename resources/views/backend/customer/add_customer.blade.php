            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="add-customer-form" action="{{ route('add.customer') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="mobile_number" class="form-control" type="text" value="" id="mobile_number">
                                </div>
                            </div>
                            <div class="row mb-3">
